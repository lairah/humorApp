...
<Tab.Navigator  screenOptions={{tabBarShowLabel: false, headerShown: false, tabBarStyle:{height:90}}}>
<Tab.Screen options={{tabBarIcon: () => <Icone name="home" color={"#304FFE"} size={24}/>, headerShown: false,}} name="home" component={Tela2}/>
<Tab.Screen options={{tabBarIcon: () => <Icone2 name="pluscircle" color={"#304FFE"} size={40} />,headerShown: false}} name="Caminhos2" component={Caminhos2} />
